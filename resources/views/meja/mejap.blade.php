...
<body>
    ...
    const items_papan = [{
            value: "item1",
            label: "Corak Kayu",
            url: "PapanMejaPanjangC.x3d",
        },
        {
            value: "item2",
            label: "Corak Marmer",
            url: "PapanMejaPanjangC1.x3d",
        },
        // Add more items as needed
    ];
    const items_kaki = [{
            value: "item1",
            label: "Kaki Meja Panjang 1",
            url: "Kaki Meja Panjang C1.x3d",
        },
        {
            value: "item2",
            label: "Kaki Meja Panjang 2",
            url: "Kaki Meja Panjang C2.x3d",
        },
        {
            value: "item3",
            label: "Kaki Meja Panjang 3",
            url: "Kaki Meja Panjang C3.x3d",
        },
        {
            value: "item4",
            label: "Kaki Meja Panjang 4",
            url: "Kaki Meja Panjang C4.x3d",
        },
        {
            value: "item5",
            label: "Kaki Meja Panjang 5",
            url: "Kaki Meja Panjang C5.x3d",
        },
        {
            value: "item6",
            label: "Kaki Meja Panjang 6",
            url: "Kaki Meja Panjang C6.x3d",
        },
        // Add more items as needed
    ];
