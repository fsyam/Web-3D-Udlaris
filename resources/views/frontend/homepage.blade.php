...
<div class="popular-product-area wrapper-padding-3 pt-115 pb-115">
    <div class="container-fluid">
        <div class="section-title-6 text-center mb-50">
            ...
            <p>Hadirkan Elegansi Tanpa Habis Kantong, Karena Kami Adalah Pilihan Furniture Termurah, Desain Terkini, Harga Paling Ringan. Itu Adalah Janji Kami</p>
        </div>
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        ...
                        <div class="product-action">
                            <a class="animate-left add-to-fav" title="Wishlist" product-slug="{{ $product->slug }}"
                                href="">
                            ...
                            <a class="animate-right quick-view" title="Quick View" product-slug="{{ $product->slug }}"
                                href="">
